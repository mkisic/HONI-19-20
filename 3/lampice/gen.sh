...
for i in {a..g}; do time ./palindromi < test/$TASK.in.1$i > test/$TASK.out.1$i; done
for i in {a..e}; do time ./palindromi < test/$TASK.in.2$i > test/$TASK.out.2$i; done
for i in {a..j}; do time ./palindromi < test/$TASK.in.3$i > test/$TASK.out.3$i; done
