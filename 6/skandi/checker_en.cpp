...
void checker(ifstream& fin, ifstream& foff, ifstream& fout)
{
  ...
  const string WRONG_ANS = "First line is not correct.";
  const string WRONG_REC =
      "First line is correct, but the reconstruction is not.";
  const string WRONG_REC_FORMAT = "First line is correct, but the "
                                  "reconstruction is not properly formatted.";
